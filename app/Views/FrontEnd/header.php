      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 col-md-7 py-4">
            <h4>Contact</h4>
            Phone <a class="text-body-secondary"><strong>+34 666 555 444</strong></a>
            <br>
            Email: <a class="text-body-secondary"><strong>7wonders@gmail.com</strong></a>
          </div>
